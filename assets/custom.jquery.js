...
$('#socks-quick .index-product-preview:first-of-type').click(function() {
  window.location.href = "/collections/womens-ankle";

}); 
                                                             
 $('#socks-quick .index-product-preview:nth-of-type(2)').click(function() {
  window.location.href = "/collections/mens-crew";

}); $('#socks-quick .index-product-preview:nth-of-type(3)').click(function() {
  window.location.href = "/collections/womens-crew";

});                                                          
             $('#socks-quick .index-product-preview:nth-of-type(4)').click(function() {
  window.location.href = "/collections/youth-crew";
...
$('#dnav a.mainlink p').on("mouseenter", function() {
  $('#dnav a.mainlink p').removeClass('border-bottom-darkgray')
...
$('body').click(function (event) {
  if((!$(event.target).is('#dnav')) && (!$(event.target).is('#mobile-filter-wrapper')) && (!$(event.target).is('#mobile-filter')) && (!$(event.target).is('#cta h4')) && (!$(event.target).is('.desktop-collections'))) {
    $('nav').removeClass('fixed-nav-collections')
    $('.desktop-collections').hide()
    $('#dnav a p').removeClass('border-bottom-darkgray')
  }
...
if ($(window).width() < 800) {
  $('#hamburger, #cta').click(function(){
    ...
    if ($(this).hasClass('cta-women')) {
      ...
      $(".fr", ".collection-prod:first").addClass('rotate180')   
    }
      ...
      $('.fr').removeClass('rotate180')
      $(".fr", ".men-collection-nav" ).addClass('rotate180') 
    }
      ...
      $('.fr').removeClass('rotate180')
      $(".fr", ".kids-collection-nav" ).addClass('rotate180') 
    }
  }); 
}
if ($(window).width() >= 800) {
